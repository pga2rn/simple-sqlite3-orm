...
entry_for_test = SampleTable(
    unix_timestamp=datetime.fromtimestamp(_cur_timestamp),
    unix_timestamp_int=datetime.fromtimestamp(int(_cur_timestamp)),
    datetime_iso8601=datetime.fromtimestamp(_cur_timestamp),
    key_id=1,
    prim_key=mstr,
